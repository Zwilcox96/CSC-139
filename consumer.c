...
int main()
{
	...
	const char *name = "OS_HW1_ZackWilcox"; // Name of shared memory block to be passed to shm_open
    ...
    int shared_fd = shm_open(name, O_RDWR, 0666);
    //ftruncate(shared_fd, bufSize);
